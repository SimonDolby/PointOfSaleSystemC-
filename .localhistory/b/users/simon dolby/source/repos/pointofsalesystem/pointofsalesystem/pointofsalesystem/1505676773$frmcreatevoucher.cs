    ...
    public partial class frmCreateVoucher : Form
    {
        ...
        private void btnCreateBarcode_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                MessageBox.Show("Please click the Generate Number button");
        ...
        private void cboxTypeofDiscount_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (cboxTypeofDiscount.SelectedIndex == 2)
            {
                lblTypeOfVoucher.Text = "Amount of Money Off";
