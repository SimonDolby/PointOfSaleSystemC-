        ...
        private void btnStartSale_Click(object sender, EventArgs e)
        {
            ...
            switch (Choice)
            {
                ...
                case 0:
                    ...
                    MessageBox.Show("Please select a category or barcode");
                    break;
            }

            cboxBarcode.SelectedIndex = 0;
            cboxCategories.SelectedIndex = 0;
            cboxBarcode.Visible = true;
            cboxCategories.Visible = true;
            Choice = 0;
        }
