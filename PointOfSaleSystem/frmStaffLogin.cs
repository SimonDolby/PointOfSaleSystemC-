...
namespace PointOfSaleSystem
{
    public partial class frmStaffLogin : Form
    {
        ...
        private void btnLogin_Click(object sender, EventArgs e)
        {
            ...
            SqlDataAdapter cmd= new SqlDataAdapter("SELECT Passcode FROM [Employee] WHERE Passcode = @pass", con);
            ...
            if (dt.Rows.Count > 0)
            {
                StaffUserPanel StaffPanel = new StaffUserPanel();
                StaffPanel.Show();
        ...
        private void btnKeyboardActivate_Click(object sender, EventArgs e)
        {
